            ...
            col.append(
                [
                    sg.Text(str(i+1)+":", font=("Comic Sans MS", 16)), sg.Input(ip[i], font=(
                        "Comic Sans MS", 16), size=(15, 1), background_color='GhostWhite', enable_events=True, key='-USERIP%s-' % (str(i+1))),
        ...
        layout = [
            ...
            [
                sg.Exit('退出', button_color=('white', 'firebrick4'),
                        key='Exit_4', size=(40, 1), font=("KaiTi", 12))
            ]
        ]
...
def LocalRandomSearch(path, window):
    ...
    try:
        ...
        print(time.strftime("[%Y-%m-%d %H:%M:%S]: ", time.localtime()), "请先识别！")
        return
    result = result.fillna('0')
    result_list = result['name'].to_list()
    cnt = 1
...
def GUI():
    ...
    layout = [
        ...
        #     ],
        #     [
        #         sg.Button('下载 | 更新', font=("KaiTi", 10),
        #                   size=(49, 1), key='-DOWNLOADBUTTON-'),
        #         sg.Button('本地识别', font=("KaiTi", 10),
    ...
    window = sg.Window('AI Sticker Searcher V1.1', layout,
